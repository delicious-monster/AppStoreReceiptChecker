...
#ifndef App_Store_Certificate_Checker_Bridging_Header_h
#define App_Store_Certificate_Checker_Bridging_Header_h

#import <CommonCrypto/CommonCrypto.h>

#endif /* App_Store_Certificate_Checker_Bridging_Header_h */
